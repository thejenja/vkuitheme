...
(function() {
    'use strict';
    // Find the gifts div on the page
    var giftsDiv = document.querySelector('#auth > div > div.right_big_block > div:nth-child(3)');
    if (giftsDiv) {
        // Find the specified div on the page
        var specifiedDiv = document.querySelector('div.' + profile_links);
        if (specifiedDiv) {
            // Insert the gifts div after the specified div
            specifiedDiv.parentNode.insertBefore(giftsDiv, specifiedDiv.nextSibling);
        }
    }
})();
